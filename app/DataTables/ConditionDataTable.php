...
class ConditionDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'conditions.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Condition $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Condition $model)
    {
